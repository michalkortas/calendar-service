...
it('returns valid day keys in day instance', function() {
    ...
    expect($instance)->toHaveKeys(['dayName', 'weekNumber', 'weekDayNumber', 'nextName', 'lastName', 'year', 'today', 'todayDay', 'nextDay', 'currentDay', 'lastDay', 'nextDayCode', 'currentDayCode', 'lastDayCode', 'monthCode', 'startFrom', 'endTo', 'isWorkingDay', 'isSaturday', 'isSunday', 'isHoliday']);
});
